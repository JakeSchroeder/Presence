...
export default {
  ...
  checkmark: (
    <svg
      viewBox="0 0 24 24"
      className="r-13gxpu9 r-4qtqp9 r-yyyyoo r-1q142lx r-1xvli5t r-1n0xq6e r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
    >
      <g>
  ...
  chevron: (
    <svg
      viewBox="0 0 24 24"
      className="r-9uu7rm r-jwli3a r-4qtqp9 r-yyyyoo r-2pyi3h r-n6v787 r-1xvli5t r-dnmrzs r-u8s1d r-1plcrui r-uoibet r-lrvibr r-lrsllp"
    >
      <g>
  ...
  dropDown: (
    <svg
      viewBox="0 0 24 24"
      className="r-hkyrab r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
    >
      <g>
  ...
  presence: (
    ...
    >
      <path
        d="M11.93,8.18c0,2.53-1.12,6-.57,9,.19,1.05,1.91,4.52,1.52,5.44-1,2.29-4.86.86-5.72.48C5,22.13,0,18.09,0,12.76,0,6.9,4.45,2.32,6.39,2.17a6.54,6.54,0,0,1,1.2.05,6.3,6.3,0,0,1,2.68,1.16C11,3.93,11.93,5,11.93,8.18Z"
        fill="#f9d623"
      />
      <path
        d="M9.27,10.85c0,1.29-.57,3.05-.29,4.6.1.54,1,2.32.78,2.79-.49,1.18-2.5.44-2.94.25C5.73,18,3.15,15.93,3.15,13.2c0-3,2.28-5.36,3.28-5.44a3.11,3.11,0,0,1,.61,0,3.16,3.16,0,0,1,1.38.59C8.77,8.66,9.27,9.2,9.27,10.85Z"
        fill="#fde95f"
      />
      <path
        d="M24,9.57c0,2.9-3,5.15-5.92,5.15s-6.29-3.3-6.29-6.2,3.39-5.16,6.29-5.16S24,6.67,24,9.57Z"
        fill="#f9d623"
      />
      <path
        d="M9.11,3c.6-.16,2.66,1.49,4.39,1.53.75,0,1.14-.35,1.63-.1.33.18.73.65.76,2.58a26.41,26.41,0,0,1-1.05,6.39h0c1.05-.19,1.14.2.57.39A10.42,10.42,0,0,1,13.5,13a1.52,1.52,0,0,0-1.33.19c-1,.67-.93,1.23-1.05,1.24C10.61,14.49,7.74,3.36,9.11,3Z"
        fill="#f9d623"
      />
      <ellipse cx="18.51" cy="5.94" rx="1.48" ry="0.67" />
      <ellipse cx="18.7" cy="5.75" rx="0.52" ry="0.19" fill="#fff" />
      <path d="M14.84,4.22a2.74,2.74,0,0,1,.48-2.57C15.93.73,17.14-.13,17.8.22a1.12,1.12,0,0,1,.47.76c.13.64-.36.87-.28,1.53s.57.75.48,1.14-.56.32-1.25,1c-.43.41-.4.58-.66.66C16,5.45,15.18,4.91,14.84,4.22Z" />
      <path d="M3.72,12.33a2.71,2.71,0,0,0,.55,1.38c.3.39.82.8,1,.67s-.1-1,0-1A4.59,4.59,0,0,0,6,14.7c.59.61,1.46.79,1.57.63s0-.18-.29-.82c-.12-.29-.12-.34-.1-.36s.48.76,1.2,1.09c1,.43,2.21-.11,2.2-.33s-.47-.07-1-.37C8.74,14,8.84,13,8.4,12.44S6.89,11.48,3.72,12.33Z" />
    </svg>
  ),
  logo: (
    <svg
      viewBox="0 0 24 24"
      className="r-13gxpu9 r-4qtqp9 r-yyyyoo r-16y2uox r-1q142lx r-8kz0gk r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
    >
      <g>
  ...
  modalMessage: (
    <svg
      viewBox="0 0 24 24"
      className="r-1re7ezh r-4qtqp9 r-yyyyoo r-1q142lx r-1xvli5t r-zso239 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
    >
      <g>
        <path d="M19.25 3.018H4.75C3.233 3.018 2 4.252 2 5.77v12.495c0 1.518 1.233 2.753 2.75 2.753h14.5c1.517 0 2.75-1.235 2.75-2.753V5.77c0-1.518-1.233-2.752-2.75-2.752zm-14.5 1.5h14.5c.69 0 1.25.56 1.25 1.25v.714l-8.05 5.367c-.273.18-.626.182-.9-.002L3.5 6.482v-.714c0-.69.56-1.25 1.25-1.25zm14.5 14.998H4.75c-.69 0-1.25-.56-1.25-1.25V8.24l7.24 4.83c.383.256.822.384 1.26.384.44 0 .877-.128 1.26-.383l7.24-4.83v10.022c0 .69-.56 1.25-1.25 1.25z"></path>
      </g>
